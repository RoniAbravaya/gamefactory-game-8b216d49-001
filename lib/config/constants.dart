...
class GameColors {
  ...
  static const Color primary = Color(0xFF9BFFBB);
  static const Color secondary = Color(0xFFFFB28D);
  static const Color accent = Color(0xFFFFF5B0);
  static const Color success = Color(0xFFBBDDFF);
  static const Color warning = Color(0xFFD97CFF);
